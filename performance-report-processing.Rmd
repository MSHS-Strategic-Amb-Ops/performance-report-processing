...
master_amb_mapping <- as.data.frame(read_excel("~/performance-report-processing/server-upload-updated/master_amb_mapping_updated.xlsx", col_types = "text"))
...
sessional_prov_mapping <- as.data.frame(read_excel("~/performance-report-processing/server-upload-updated/master_amb_sessional_provider_mapping.xlsx", col_types = "text"))
sessional_prov_mapping <- sessional_prov_mapping %>%
  mutate(mapping_unique_id = paste0(Department,Provider))
...
scheduling_data_raw$`Sessional Site` <- sessional_prov_mapping$`Sessional Site`[match(scheduling_data_raw$mapping_unique_id , sessional_prov_mapping$mapping_unique_id)]
scheduling_data_raw$`Sessional Managed` <- sessional_prov_mapping$`Sessional Managed`[match(scheduling_data_raw$mapping_unique_id , sessional_prov_mapping$mapping_unique_id)]
scheduling_data_raw$`Sessional Campus.Specialty.Group` <- sessional_prov_mapping$`Sessional Campus.Specialty.Group`[match(scheduling_data_raw$mapping_unique_id , sessional_prov_mapping$mapping_unique_id)]
scheduling_data_raw$`Sessional Office` <- sessional_prov_mapping$`Sessional Office`[match(scheduling_data_raw$mapping_unique_id, sessional_prov_mapping$mapping_unique_id)]
...
appt_type_mapping <- as.data.frame(read_excel("~/performance-report-processing/server-upload-updated/master_amb_appt_type_mapping.xlsx", col_types = "text"))
appt_type_mapping <- appt_type_mapping %>%
  mutate(mapping_unique_id = paste0(Campus.Specialty.Group, `Appointment type`))

scheduling_data_raw <- scheduling_data_raw %>%
  mutate(mapping_unique_id = paste0(Campus.Specialty.Group, Appt.Type))

scheduling_data_raw$Classification <- appt_type_mapping$Classification[match(scheduling_data_raw$mapping_unique_id, appt_type_mapping$mapping_unique_id)]


invisible(gc())


scheduling_data_raw$Classification[is.na(scheduling_data_raw$Classification)] <- "NA"
...
scheduling_data_raw <- scheduling_data_raw %>%
  mutate(Office = ifelse(Classification == "NA", Office, Classification)) 
...
dept_zip_code_ref <- read_csv("~/performance-report-processing/server-upload-updated/Department_Zip_Code.csv")
...
save_path <- "~/performance-report-processing/processed-data/"
...
waitTime_dist_specialty <- scheduling_data_raw %>%
  filter(Appt.Made.DateYear >= quarter_start)
invisible(gc())

waitTime_dist_specialty <- scheduling_data_raw %>%
  filter(Appt.Made.DateYear < quarter_end) 
invisible(gc())
...
waitTime_dist_specialty_ytd <- data %>%
  group_by(Campus.Specialty.Group, Campus.Specialty.SubGroup, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE))
invisible(gc())

waitTime_dist_specialty_ytd <- waitTime_dist_specialty_ytd  %>%
...
### By Specialty and Provider
waitTime_prov_ytd <- data %>%
  filter(New.PT2 == "New") 
invisible(gc())

waitTime_prov_ytd <- waitTime_prov_ytd %>%
...
# Processing by Campus.Specialty.Group -----------------------------------------
## MSHS New Patient Wait Time Horizon ===============================================
waitTime_dist_specialty_group_ytd <- data %>%  
  group_by(Campus.Specialty.Group, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE)) 
invisible(gc())

waitTime_dist_specialty_group_ytd <- waitTime_dist_specialty_group_ytd %>%
...
## MSHS New Patient Wait Time Horizon ===============================================
waitTime_dist_site_group_ytd <- data %>%  
  group_by(Campus.Specialty.Group, Site, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE)) 
invisible(gc())

waitTime_dist_site_group_ytd <- waitTime_dist_site_group_ytd %>%
...
### By Specialty and Provider
waitTime_prov_group_ytd <- data %>%
  filter(New.PT2 == "New") 
invisible(gc())

waitTime_prov_group_ytd <- waitTime_prov_group_ytd %>%
...
rm(waitTime_dist_site_group_ytd)
rm(waitTime_dist_prov_group_ytd)
rm(waitTime_mshs_group_ytd)
rm(waitTime_prov_group_ytd)
...
waitTime_dist_specialty_office_ytd <- data %>%
  group_by(Campus.Specialty.Group, Campus.Specialty.SubGroup, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE)) 
invisible(gc())

waitTime_dist_specialty_office_ytd <- waitTime_dist_specialty_office_ytd %>%
  group_by(Campus.Specialty.Group, Campus.Specialty.SubGroup, Appt.Made.Year, New.PT2, Visit.Method, med_wait, group) %>%
  summarise(total = n())
...
## MSHS New Patient Wait Time Horizon ===============================================
waitTime_dist_site_office_ytd <- data %>%
  group_by(Campus.Specialty.Group, Campus.Specialty.SubGroup, Site, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE)) 
invisible(gc())

waitTime_dist_site_office_ytd <- waitTime_dist_site_office_ytd %>%
  group_by(Campus.Specialty.Group, Campus.Specialty.SubGroup, Site, Appt.Made.Year, New.PT2, Visit.Method, med_wait, group) %>%
  summarise(total = n())
invisible(gc())
...
# Processing by Campus.Specialty.Group -----------------------------------------
## MSHS New Patient Wait Time Horizon ===============================================
waitTime_dist_specialty_group_office_ytd <- data %>%
  group_by(Campus.Specialty.Group, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE)) 
invisible(gc())

waitTime_dist_specialty_group_office_ytd <- waitTime_dist_specialty_group_office_ytd %>%
  group_by(Campus.Specialty.Group, Appt.Made.Year, New.PT2, Visit.Method, med_wait, group) %>%
  summarise(total = n())
invisible(gc())
...
## MSHS New Patient Wait Time Horizon ===============================================
waitTime_dist_site_group_office_ytd <- data %>%
  group_by(Campus.Specialty.Group, Site, Appt.Made.Year, New.PT2) %>%
  mutate(med_wait = median(Wait.Time, na.rm = TRUE))
invisible(gc())

waitTime_dist_site_group_office_ytd <- waitTime_dist_site_group_office_ytd %>%
  group_by(Campus.Specialty.Group, Site, Appt.Made.Year, New.PT2, Visit.Method, med_wait, group) %>%
  summarise(total = n())
invisible(gc())
...
## Median Wait Time ============================================================
### By Specialty
waitTime_mshs_group_office_ytd <- data %>%
  group_by(Campus.Specialty.Group, Appt.Made.Year, New.PT2) %>%
  summarise(med_wait = median(Wait.Time, na.rm = TRUE))
invisible(gc())
          
### By Specialty and Site
waitTime_site_group_office_ytd <- data %>%
  group_by(Campus.Specialty.Group, Appt.Made.Year, Site, New.PT2) %>%
  summarise(med_wait = median(Wait.Time, na.rm = TRUE))
invisible(gc())
...
### By Specialty and Provider
waitTime_prov_group_office_ytd <- data %>%
  filter(New.PT2 == "New") 
invisible(gc())

waitTime_prov_group_office_ytd <- waitTime_prov_group_office_ytd %>%
  group_by(Campus.Specialty.Group, Site, Appt.Made.Year, Provider, NPI) %>%
  summarise(med_wait = as.numeric(median(Wait.Time, na.rm = TRUE)))
invisible(gc())
...
monthly_vol <- scheduling_data_raw %>%
  ...
  filter(Appt.DateYear >= quarter_start) %>%
  filter(Appt.DateYear < quarter_end) %>%
...
payer_mix_quarter_site_office <- payer_mix_quarter_site_office %>%
  filter(Appt.Status == "Arrived") 
invisible(gc())
...
rm(monthly_vol)
rm(monthly_vol_office)
rm(vol_zip_code)
rm(vol_zip_code_office)
rm(payer_mix_quarter_site)
rm(payer_mix_quarter_site_office)
